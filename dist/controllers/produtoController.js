"use strict";const Produtos = require('../models/produtoModel.js');
...
module.exports = {
  async create(req, res) {
    try {
      ...
      if (descCheck) {
        if (descCheck.length < 6 || descCheck.length > 255) {
      ...
      const produtos = await Produtos.create({ nome: nomeCheck, descricao: descCheck, preco: precoCheck, quantidade: qtdCheck });
